---
title: "Analyse statistique en utilisant DESeq2"
author: "Chaimae"
date: "27/11/2021"
...
### A faire avant de lancer les plots 

Pour installer DESeq2, IL FAUT LA VERSION 4.1 de R d'après internet
...
On télécharge les données depuis les fichiers de count dans le dossier result qui a été généré par le Snakefile

```{r téléchargement des données, }
...
```{r}
save.image(file="analysis_R/Analysis.html")
```
